    ...
    <div class="row justify-content-center">
        ...
        @include('util.message')
            <div class="card">
                ...
                <div class="card-body">
                    <strong>@lang('messages.ProductName')</strong> {{ $data["notEcoProduct"]->getName() }}<br />
                    <strong>@lang('messages.ProductEmision')</strong> {{ $data["notEcoProduct"]->getEmision() }}<br />
                    <strong>@lang('messages.ProductLife')</strong> {{ $data["notEcoProduct"]->getProductLife() }}<br /><br />
